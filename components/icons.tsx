...
export const Cog6ToothIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M9.594 3.94c.09-.542.56-1.007 1.11-1.226a11.95 11.95 0 013.586 0c.55.219 1.02.684 1.11 1.226M12 21a9.75 9.75 0 100-19.5 9.75 9.75 0 000 19.5zM12 12.75a3 3 0 100-6 3 3 0 000 6z" />
  </svg>
);
